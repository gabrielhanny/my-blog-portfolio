...
//   const userHeadline = session?.user?.headline || 'Frontend Developer';

//   return (
//     <>
//       <NavbarLoggedIn />
//       <main className='custom-container pt-12 lg:pt-[48px]'>
//         {/* AUTHOR INFO */}
...
//             <button className='border-primary-300 text-primary-300 border-b-2 py-2'>
//               Your Post
//             </button>
  ...
  return (
    <>
      ...
      <main className='custom-container pt-12 pb-[224px] lg:pt-[48px]'>
        ...
        {/* BLOGCARD LIST */}
        <section className='mx-auto mt-4 max-w-[800px] space-y-4'>
          {isLoading ? (
            <p>Loading...</p>
          ) : isError ? (
